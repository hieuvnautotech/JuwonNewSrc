...
namespace Juwon.Controllers.Standard.General
{
    ...
    public class StaffHieuController : BaseController
    {
        private readonly IStaffHieuService staffhieuService;

        public StaffHieuController(IStaffHieuService IStaffHieuService)
        {
