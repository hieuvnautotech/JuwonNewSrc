    ...
    $.ajax({
        ...
        .done(function (response) {
            if (response.Data && response.HttpResponseCode != 100) {
                ...
                $hieuGrid.addRowData(response.Data.SupplierId, response.Data, `first`);
                $hieuGrid.setRowData(response.Data.SupplierId, false, { background: '#39FF14' });
